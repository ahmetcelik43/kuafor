...
<meta http-equiv="Expires" content="0" />
   ...
   <script src="<?php echo e(URL::asset('bower_components/angular/angular.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(URL::asset('js/angular/a.js')); ?>"></script>
    
<!--    <script src="http://127.0.0.1:8000/socket.io/socket.io.min.js"></script> --> 

   <!-- <script src="<?php echo e(URL::asset('bower_components/socket.io-client/dist/socket.io.min.js')); ?>"></script>
    
    <script src="<?php echo e(URL::asset('bower_components/angular-socket-io/socket.min.js')); ?>"></script>

   -->
 <!-- <script  type="module"  src="<?php echo e(URL::asset('socket.js')); ?>"></script>-->
 
 <script src="<?php echo e(URL::asset('bower_components/ng-websocket/ng-websocket.js')); ?>"></script>
 <script src="<?php echo e(asset('socket.io/socket.io.min.js')); ?>"></script> 
 <script src="<?php echo e(URL::asset('bower_components/angular-socket-io/socket.min.js')); ?>"></script>
 ...
 <script src="<?php echo e(URL::asset('bower_components/angular-animate/angular-animate.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(URL::asset('components/yayinlananilanlar.js')); ?>"></script>
...
<body ng-controller="main" id="main">
  ...
  <input type="hidden"  value="<?php echo e($ilanlarByID); ?>" name="ilanlarByID">
...
<?php /**PATH C:\Users\dell\blogApi\blogapi\public/master.blade.php ENDPATH**/ ?>