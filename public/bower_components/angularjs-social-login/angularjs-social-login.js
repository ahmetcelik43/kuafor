...
var socialLogin = angular.module('socialLogin', ['ui.router','ngCookies']);
...
socialLogin.directive("gLogin", ['$rootScope', 'social', 'socialLoginService','$stateParams','$cookies',
	function($rootScope, social, socialLoginService,$stateParams,$cookies){
	return {
		restrict: 'EA',
		scope: {},
		replace: true,
		link: function(scope, ele, attr){
			ele.on('click', function(){
				//console.log('prevUrl'+$stateParams.prevUrl)
						//$cookies.put('prevUrl',$stateParams.prevUrl);
