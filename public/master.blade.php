...
<meta http-equiv="Expires" content="0" />
   ...
   <link rel="stylesheet" href="{{ URL::asset('/css/tabs/tab.css') }}" />
     ...
     <link rel="stylesheet" href="{{ URL::asset('css/isteven-multi-select.css') }}" />
   ...
   <script src="{{ URL::asset('bower_components/angular/angular.min.js') }}"></script>
    ...
    <script src="{{ URL::asset('js/isteven-multi-select.js') }}"></script>
    ...
    <script src="{{ URL::asset('bower_components/angularjs-social-login/angularjs-social-login.js') }}"></script>
    <script src="{{ URL::asset('bower_components/angular-cache/dist/angular-cache.min.js') }}"></script>
...
<!--    <script src="http://127.0.0.1:8000/socket.io/socket.io.min.js"></script> --> 
 ...
 <script src="{{ URL::asset('bower_components/angular-animate/angular-animate.min.js') }}"></script>
    ...
    <script src="{{ URL::asset('components/home.js') }}"></script>
    <script src="{{ URL::asset('components/ilanlar.js') }}"></script>
    ...
    <script src="{{ URL::asset('components/altComponents/dropzoneCtrl.js') }}"></script>
    <script src="{{ URL::asset('js/angular/uniqID.js') }}"></script>
    <script src="{{ URL::asset('components/profil.js') }}"></script>
