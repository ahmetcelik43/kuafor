...
(function (root, factory) {
  ...
  angular.module('complete', [] )
    .directive('complete', ['$q', '$parse', '$http', '$sce', '$timeout', '$templateCache','$browser', function ($q, $parse, $http, $sce, $timeout, $templateCache,$browser) {
    // keyboard events
    var KEY_DW  = 40;
    var KEY_RT  = 39;
    var KEY_UP  = 38;
...
*/
    return {
      ...
      link: function(scope, elem, attrs, ctrl) {
        ...
        var listn=function()
        {
          elem.find('input').val(scope.data);
